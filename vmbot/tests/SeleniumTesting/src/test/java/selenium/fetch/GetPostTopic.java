...
public class GetPostTopic 
{
	...
	public static void main(String[] args) throws InterruptedException, IOException
	{
		...
		List<Post> posts = scrapper.ReadPostsCSV("/Users/Akash/Desktop/posts--2016-04-01_14-36-24-UTC.csv");
...
//$x("//h2/following-sibling::div//h3//a/@href")
//$x("//body/div[@class='container']//section/div[@id='dynamicStudies']/div[@class='row']/div[@class='span4']")